...
class GrossProfitGenerator(object):
	...
	def get_returned_invoice_items(self):
		returned_invoices = frappe.db.sql("""
			...
			where
				...
				and si.docstatus = 1
				and si.is_return = 1
				and si.jenis_transaksi = %s
		""", (self.filters['jenis_transaksi']), as_dict=1)
		
		# frappe.throw(str(returned_invoices))
	...
	def load_invoice_items(self):
		...
		if self.filters.jenis_transaksi:
			conditions += " and jenis_transaksi = %(jenis_transaksi)s"
