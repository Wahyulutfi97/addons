...
def custom_get_payment_entry(dt, dn, party_amount=None, bank_account=None, bank_amount=None):
	...
	if doc.doctype in ["Sales Order","Purchase Order","Sales Invoice","Purchase Invoice"]:
		if doc.jenis_transaksi == "PPN":
			pe.jenis_transaksi = "PPN"
			pe.naming_series = "ACC-PAY-P-.YY.-.MM.-.#####"
			pe.tax_status = "Tax"
		else:
			pe.jenis_transaksi = "Non PPN"
			pe.naming_series = "ACC-PAY-NP-.YY.-.MM.-.#####"
			pe.tax_status = "Non Tax"
